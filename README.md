...
**Important update (19/03/2025):** MESA version r24.08.1 is now live (see [this link](https://docs.mesastar.org/en/24.08.1/using_mesa.html)). The MESA code provided in this repository is fully compatible with MESA r24.08.1, provided one small change in the configuration inlist file. For convenience, an updated version of the MESA configuration inlist with the necessary change is now provided in this repository.
